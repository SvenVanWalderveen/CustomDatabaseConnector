...
namespace CustomDatabaseConnectorDll.Interface
{
    internal interface IDatabase
    {
        ...
        //bool CreateObject(object obj, out CustomDatabaseErrorMessage errorMessage);
        ...
        //bool ExecuteSqlStatement(string sqlQuery, out CustomDatabaseErrorMessage errorMessage);
        ...
        bool CreateObject(object obj, out CustomDatabaseErrorMessage errorMessage);
        bool CreateObject(object obj, out int newRecordId, out CustomDatabaseErrorMessage errorMessage);
        bool CreateTable(Type objectType, out CustomDatabaseErrorMessage errorMessage);
        string CreateObjectScript(object obj, out CustomDatabaseErrorMessage errorMessage);
        string CreateTableScript(Type objectType, out CustomDatabaseErrorMessage errorMessage);
        bool DeleteObject(object obj, out CustomDatabaseErrorMessage errorMessage);
        bool DropTable(Type objectType, out CustomDatabaseErrorMessage errorMessage);
        string DropTableScript(Type objectType, out CustomDatabaseErrorMessage errorMessage);
        bool UpdateObject(object obj, out CustomDatabaseErrorMessage errorMessage);
        DataTable QueryData(Type objectType, out CustomDatabaseErrorMessage errorMessage);
        DataTable QueryData(Type objectType, List<CustomDatabaseWhereParameter> whereParameters, out CustomDatabaseErrorMessage errorMessage);
        bool ExecuteSqlStatement(string sqlStatement, out CustomDatabaseErrorMessage errorMessage);
    }
}
